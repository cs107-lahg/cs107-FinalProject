...
'''
usage:
    sin(x) --> x.sin() or np.sin(x)
    cos(x) --> x.cos() or np.sin(x)
    tan(x) --> x.tan(x) or np.tan(x)
    exp(x) --> x.exp() or np.exp(x)
    arcsin(x) --> x.arcsin() or np.arcsin(x)
    arccos(x) --> x.arccos() or np.arccos(x)
    arctan(x) --> x.arctan() or no.arctan(x)
'''