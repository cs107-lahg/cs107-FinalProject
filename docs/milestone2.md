...
You will need to install neccesary dependencies in order to use the package properly. This can be done using the Linux command after nevigating to the directory containing the **requirements.txt** file:
...
| self.sin           | This method will be used to find the sine of an intermediate value. It will calculate the cos for differentiation                                     |
| self.cos           | This method will be used to find the cosine of an intermediate value. It will calculate the -sin for differentiation                                  |
