...
def test_rdsin():
    ...
    f = x.sin()
    assert np.array_equal(np.round(f.get_value(),8), np.array([0.84147098, 0.90929743, 0.14112001]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([ 0.54030231, -0.41614684, -0.9899925 ]))
...
def test_rdcos():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.cos()
    assert np.array_equal(np.round(f.get_value(),8), np.array([ 0.54030231, -0.41614684, -0.9899925 ]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([ -0.84147098, -0.90929743, -0.14112001]))
...
def test_rdtan():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.tan()
    assert np.array_equal(np.round(f.get_value(),8), np.array([ 1.55740772, -2.18503986, -0.14254654]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([3.42551882, 5.7743992 , 1.02031952]))
...
def test_rdsinh():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.sinh()
    assert np.array_equal(np.round(f.get_value(),8), np.array([ 1.17520119,  3.62686041, 10.01787493]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([ 1.54308063,  3.76219569, 10.067662  ]))
...
def test_rdcosh():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.cosh()
    assert np.array_equal(np.round(f.get_value(),8), np.array([ 1.54308063,  3.76219569, 10.067662  ]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([1.17520119,  3.62686041, 10.01787493]))
...
def test_rdtanh():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.tanh()
    assert np.array_equal(np.round(f.get_value(),8), np.array([0.76159416, 0.96402758, 0.99505475]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([0.41997434, 0.07065082, 0.00986604]))
...
def test_rdsqrt():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.sqrt()
    assert np.array_equal(np.round(f.get_value(),8), np.array([1.        , 1.41421356, 1.73205081]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([0.5       , 0.35355339, 0.28867513]))
...
def test_rdarcsin():
    ...
    f = x.arcsin()
    assert np.array_equal(np.round(f.get_value(),8), np.array([0.10016742, 0.20135792, 0.30469265]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([1.00503782, 1.02062073, 1.04828484]))
...
def test_rdarccos():
    ...
    x = ad.RD(np.array([0.1, 0.2, 0.3]))
    f = x.arccos()
    assert np.array_equal(np.round(f.get_value(),8), np.array([1.47062891, 1.36943841, 1.26610367]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([-1.00503782, -1.02062073, -1.04828484]))
...
def test_rdarctan():
    ...
    x = ad.RD(np.array([0.1, 0.2, 0.3]))
    f = x.arctan()
    assert np.array_equal(np.round(f.get_value(),8), np.array([0.09966865, 0.19739556, 0.29145679]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([0.99009901, 0.96153846, 0.91743119]))
...
def test_rdlog():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.log(base = np.e)
    assert np.array_equal(np.round(f.get_value(),8), np.array([0.        , 0.69314718, 1.09861229]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([1.        , 0.5       , 0.33333333]))
...
def test_rdexp():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.exp()
    assert np.array_equal(np.round(f.get_value(),8), np.array([ 2.71828183,  7.3890561 , 20.08553692]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([ 2.71828183,  7.3890561 , 20.08553692]))
    with pytest.raises(Exception):
        x.exp(base = "Natural")
...
def test_rdlogistic():
    ...
    x = ad.RD(np.array([1, 2, 3]))
    f = x.logistic()
    assert np.array_equal(np.round(f.get_value(),8), np.array([0.73105858, 0.88079708, 0.95257413]))
    assert np.array_equal(np.round(x.get_derivative(),8), np.array([0.19661193, 0.10499359, 0.04517666]))
